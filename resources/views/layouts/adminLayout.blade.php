    ...
    <div class="menu-list">
        <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu collapse" id="members">
                <li><a href="{{route('members')}}"><div>All members</div></a></li>
                <li><a href="{{route('addMember')}}"><div>New member</div></a></li>
            </ul>
            ...
            <ul class="sub-menu collapse" id="memberships">
                <li><a href="{{route('activeMemberships')}}"><div>Active memberships</div></a></li>
                <li><a href="{{route('membershipTypes')}}"><div>Membership types</div></a></li>
                <li><a href="{{route('addMembershipType')}}"><div>New membership type</div></a></li>
            </ul>
            ...
            <ul class="sub-menu collapse" id="employees">
                <li><a href="{{route('employees')}}"><div>All employees</div></a></li>
                <li><a href="{{route('addWorker')}}"><div>New employee</div></a></li>
            </ul>
            ...
            <ul class="sub-menu collapse" id="shopitems">
                <li><a href="{{route('items')}}"><div>All items</div></a></li>
                <li><a href="{{route('newItem')}}"><div>New item</div></a></li>
                <li><a href="{{route('categories')}}"><div>Categories</div></a></li>
                <li><a href="{{route('addCategory')}}"><div>New category</div></a></li>
            </ul>

            <li>
                <a href="{{route('attendance')}}"><div>
