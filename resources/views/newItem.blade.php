...
@section('content')
    ...
    <form id="form" action="{{ route('newItem') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-5">
            ...
            <input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="Enter manufacturer" value="{{old('manufacturer')}}">
        </div>

        <div class="form-group col-md-5">
            <label for="size">Size</label>
            <input type="text" class="form-control" id="size" name="size" placeholder="Enter size" value="{{old('size')}}">
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <input type="file" class="form-control-file" id="image" name="image" accept="image/jpeg" value="{{old('image')}}">
            <p id="error"></p>
        </div>
